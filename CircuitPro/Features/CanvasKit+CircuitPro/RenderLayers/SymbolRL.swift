    ...
    var body: CKLayer {
        ...
        return CKLayer {
            for component in components {
                SymbolView(component: component).body
            }
        }
    }
}
...
struct SymbolView {
    ...
    var body: CKLayer {
        ...
        return CKLayer {
            ...
            if !bodyPrimitives.isEmpty {
                CKLayer { _ in bodyPrimitives }
            }

            for entry in textEntries {
                AnchoredTextView(entry: entry).body
            }
        }
    }
